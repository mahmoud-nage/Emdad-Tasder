    ...
    @foreach (json_decode($coupon->details) as $key => $details)
        <div class="product-choose">
            <div class="form-group">
               ...
               <div class="col-lg-9">
                  <select class="form-control category_id select2" name="category_ids[]" required>
            ...
            <div class="form-group" id="subcategory">
               ...
               <div class="col-lg-9">
                  <select class="form-control subcategory_id select2" name="subcategory_ids[]" required>
            ...
            <div class="form-group" id="subsubcategory">
               ...
               <div class="col-lg-9">
                  <select class="form-control subsubcategory_id select2" name="subsubcategory_ids[]" required>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-9">
                    <select name="product_ids[]" class="form-control product_id select2" required>
