        ...
        <div class="panel-body">
            ...
            <div class="pad-top">
                    ...
                    <div class="media bord-top pad-top">
                                    ...
                                    @endphp
                        <a class="media-left" href="#"><img class="img-circle img-sm" alt="Profile Picture" src="{{ asset($image) }}">
                        </a>
                ...
                <div class="media bord-top pad-top">
                      @php
                                        $image1 = isset($ticket->user->avatar) ? $ticket->user->avatar : 'https://kooledge.com/assets/default_medium_avatar-57d58da4fc778fbd688dcbc4cbc47e14ac79839a9801187e42a796cbd6569847.png';
                                    @endphp
                    <a class="media-left" href="#"><img class="img-circle img-sm" alt="Profile Picture" src="{{ asset($image1) }}">
                    </a>
                    <div class="media-body">
                        <div class="comment-header">
