        ...
        <div class="panel">
            ...
            <form class="form-horizontal" action="{{ route('generalsettings.update',$generalsetting->id ) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" id="address" name="address" value="{{ $generalsetting->address }}" class="form-control" required>
                                        ...
                                        <div class="form-group">
                        <label class="col-sm-3 control-label" for="address">{{__('Address Ar')}}</label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label" for="google_plus">{{__('Google play link')}}</label>
                        <div class="col-sm-9">
                            <input type="text" id="google_play_store" name="google_play_store" value="{{ $generalsetting->google_play_store }}" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label" for="google_plus">{{__('Apple store link')}}</label>
                        <div class="col-sm-9">
                            <input type="text" id="apple_store" name="apple_store" value="{{ $generalsetting->apple_store }}" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label" for="google_plus">{{__('Withdrawal Duration')}}</label>
                        <div class="col-sm-9">
                            <input type="number" id="withdrawal_duration" name="withdrawal_duration" value="{{ $generalsetting->withdrawal_duration }}" class="form-control">
                        </div>
                    </div>
                </div>
