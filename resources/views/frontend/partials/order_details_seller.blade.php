...
<div class="modal-body gry-bg px-3 pt-0">
    <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-lg-6">
                        ...
                        <div class="order-row">
                            ...
                            <span class="order-number">{{$order->status['name_'.app()->getLocale()]}}</span>
                        </div>
        ...
        <div class="col-xs-12 col-lg-4">
            <div class="section-wrapper" style="margin-top: -5px">
                <div class="section-header">
                    {{__('general.order_summery')}}
                </div>
                    @if($order->orderDetails->count()>0)
                <div class="order-wrapper">
                    ...
                    <div class="order-row">
				        ...
				        @endif
				        <div class="order-row">
                        <span class="order-title">{{__('general.commission')}}</span>
                        <span class="order-number">{{ $order->orderDetails->sum('commission') }}{{  isset($order->country->Currency['name_'.app()->getLocale()])?  $order->country->Currency['name_'.app()->getLocale()]:'' }}</span>
                        </div>
                    <div class="order-row">
                        <span class="order-title">{{__('general.total')}}</span>
                        <span class="order-number">{{ $order->grand_total - $order->orderDetails->sum('commission') }}{{  isset($order->country->Currency['name_'.app()->getLocale()])?  $order->country->Currency['name_'.app()->getLocale()]:'' }}</span>
                    </div>
                </div>
                @endif
            </div>
