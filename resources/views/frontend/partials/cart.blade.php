                ...
                @if(count($cart = Session::get('cart')) > 0)
                    ...
                    <div class="py-2 text-center dc-btn">
                        <ul class="inline-links inline-links--style-3">
                            <li class="pr-3">
                                <a href="{{ route('cart',['country' => get_country()->code]) }}" class="link link--style-1 text-capitalize btn btn-base-1 px-3 py-1">
                                    <i class="la la-shopping-cart"></i> {{__('View cart')}}
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('checkout.shipping_info',['country' => get_country()->code]) }}" class="link link--style-1 text-capitalize btn btn-base-1 px-3 py-1 light-text">
