                            ...
                            <div class="row align-items-center">
                                <div class="col-md-6">
                                    <h2 class="heading heading-6 text-capitalize strong-600 mb-0">
                                        ...
                                        <a href="{{ route('shop.visit', ['country' => get_country()->code, 'slug'=>$shop->slug] ) }}" class="btn btn-link btn-sm" target="_blank">({{__('Visit Shop')}} <i class="la la-external-link"></i>)</a>
                                    </h2>
                                </div>
                                <div class="col-md-6">
                                    <div class="float-md-right">
                                        <ul class="breadcrumb">
                                            <li><a href="{{ route('home',['country' => get_country()->code]) }}">{{__('Home')}}</a></li>
                                            <li><a href="{{ route('dashboard',['country' => get_country()->code]) }}">{{__('Dashboard')}}</a></li>
                                            <li class="active"><a href="{{ route('shops.index',['country' => get_country()->code]) }}">{{__('Shop Settings')}}</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <form class="" action="{{ route('shop.verify.store',['country' => get_country()->code]) }}" method="POST" enctype="multipart/form-data">
                            @csrf
