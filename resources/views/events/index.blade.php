...
<div class="row">
    <div class="col-sm-12">
        <a href="{{ route('events.create')}}" class="btn btn-rounded btn-info pull-right">{{__('Add New Event')}}</a>
    </div>
</div>
                        ...
                        <td>
                            <div class="btn-group dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    <li><a href="{{route('events.edit', encrypt($record->id))}}">{{__('Edit')}}</a></li>
                                    <li><a onclick="confirm_modal('{{route('events.destroy', $record->id)}}');">{{__('Delete')}}</a></li>
                                </ul>
                            </div>
                        </td>
                    </tr>
