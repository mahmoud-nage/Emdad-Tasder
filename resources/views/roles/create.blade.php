            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="row">
                            <div class="col-sm-10">
                                <label class="control-label">{{ __('Seller Orders') }}</label>
                            </div>
                            <div class="col-sm-2">
                                <label class="switch">
                        ...
                        <div class="row">
                            <div class="col-sm-10">
                                <label class="control-label">{{ __('Global Settings') }}</label>
                            </div>
                            <div class="col-sm-2">
                                <label class="switch">
                        ...
                        <div class="row">
                            <div class="col-sm-10">
                                <label class="control-label">{{ __('Shipment Aramex Pichup') }}</label>
                            </div>
                            <div class="col-sm-2">
                                <label class="switch">
                        ...
                        <div class="row">
                            <div class="col-sm-10">
                                <label class="control-label">{{ __('Reports') }}</label>
                            </div>
                            <div class="col-sm-2">
                                <label class="switch">
                        ...
                        <div class="row">
                            <div class="col-sm-10">
                                <label class="control-label">{{ __('Notifications') }}</label>
                            </div>
                            <div class="col-sm-2">
                                <label class="switch">
