                ...
                <div class="panel-body">
                    <form class="form-horizontal" action="{{ route('google_analytics.update') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <input type="text" class="form-control" name="TRACKING_ID" value="{{ isset($business_settings->where('type', 'TRACKING_ID')->first()->value)?$business_settings->where('type', 'TRACKING_ID')->first()->value:'' }}" placeholder="Tracking ID" required>
                            </div>
                        </div>
                        <div class="form-group">
