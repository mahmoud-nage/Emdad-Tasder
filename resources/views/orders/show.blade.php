...
<div class="panel">
    <div class="panel-body">
        ...
        <div class="row">
            ...
            <div class="col-lg-offset-6 col-lg-3">
                ...
                <select class="form-control select2" data-minimum-results-for-search="Infinity"
                    ...
                    <option value="paid" disabled @if ($payment_status=='paid' ) selected @endif>{{__('forms.paid')}}
                    </option>
                    @endif
                    @if ($payment_status == 'unpaid')
                    <option value="unpaid" disabled @if ($payment_status=='unpaid' ) selected @endif>
                        {{__('forms.unpaid')}}</option>
                    @endif
                </select>
            </div>
            <div class="col-lg-3">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                {{  isset($order->country->Currency)?  $order->country->Currency['name_'.app()->getLocale()]:'' }}
                            </td>
                            <td class="text-center">
                                {{ $orderDetail->price }}
                                {{  isset($order->country->Currency)?  $order->country->Currency['name_'.app()->getLocale()]:'' }}
        ...
        <div class="clearfix">
            <table class="table invoice-total">
                <tbody>
                    ...
                    <!--     </td>-->
                    <!--     <td class="text-info">-->
                    <!--         {{ $order->orderDetails->sum('commission') }} {{  isset($order->country->Currency->symbol)?  $order->country->Currency->symbol:'' }}-->
                    <!--     </td>-->
                    <!-- </tr>-->
                    ...
                    <tr>
                        ...
                        <td class="text-bold h4 text-info" @if($order->status_id == 5)
                            ...
                            $order->grand_total ({{__('forms.paid')}})
                            @else
                            {{ $order->grand_total }}{{  isset($order->country->Currency)?  $order->country->Currency['name_'.app()->getLocale()]:'' }}
                            @if($order->status_id == 5)
        ...
        <div class="text-right no-print">
            <a target="blank" href="{{ route('admin.invoice.download', $order->id) }}" class="btn btn-default"><i
