...
<div class="col-lg-10 col-lg-offset-1">
    <div class="panel">
        ...
        <!--Horizontal Form-->
        <!--===================================================-->
        <form class="form-horizontal" action="{{ route('galleries.update', $record->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <input type="url" value="{{$record->video_link}}" class="form-control @error('video_link') is-invalid @enderror"
                               name="video_link">
                        @error('video_link')
                        <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
