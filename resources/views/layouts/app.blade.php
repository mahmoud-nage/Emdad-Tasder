...
<head>
    ...
    <link name="favicon" type="image/x-icon" href="{{ asset($general_setting->favicon) }}" rel="shortcut icon" />
    ...
    <link href="//cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.min.css" rel="stylesheet">
        ...
        @if(app()->isLocale('ar'))
        <link rel="stylesheet" type="text/css" href="{{ asset('assets/seller/css/style-rtl.css') }}">
    @endif
