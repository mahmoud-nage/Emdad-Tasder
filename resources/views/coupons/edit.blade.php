            ...
            <form class="form-horizontal" action="{{ route('coupon.update', $coupon->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label class="col-lg-3 control-label" for="name">{{__('Coupon Type')}}
                            <span class="text-danger">*</span>
                        </label>
                        <div class="col-lg-9">
                            <select name="coupon_type" id="coupon_type" class="form-control select2" onchange="coupon_form()" required>
