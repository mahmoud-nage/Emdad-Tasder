...
class HomeCategoryController extends Controller
{
    ...
    {
        $type = $request->type;
        return view('home_categories.create',compact('type'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $home_category->type = $request->type;
    ...
    public function edit($id)
    {
        ...
        return view('home_categories.edit', compact('homeCategory','type'));
    }
