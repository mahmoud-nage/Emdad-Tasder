...
class GeneralSettingController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $generalsetting->google_play_store = $request->google_play_store;
        $generalsetting->apple_store = $request->apple_store;
        $generalsetting->withdrawal_duration = $request->withdrawal_duration;
